    ...
    public String validIPAddress(String IP) {
        if (IP.isBlank()) return "Neither";
            ...
            for (String item : items) {
                if (!isValid6(item)) return "Neither";
            }
            return "IPv6";
        } else if (IP.contains(".")) {
            String[] items = IP.split("\\.");
            ...
            for (String item : items) {
                if (!isValid4(item)) return "Neither";
            }
            return "IPv4";
        } else return "Neither";
    }

    private boolean isValid4(String item) {
        ...
        return Integer.parseInt(item) <= 255;
    }

    private boolean isValid6(String item) {
        if (item.isBlank()) return false;

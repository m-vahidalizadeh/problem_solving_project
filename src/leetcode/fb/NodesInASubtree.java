 ...
 * Signature
 * int[] countOfNodes(leetcode.base.Node root, ArrayList<Query> queries, String s)
 * Input
 ...
 * leetcode.base.Node 1 is the root of the tree
 * Output
 ...
 * query = [[1, 'a']]
 * output = [2]
 * Both leetcode.base.Node 1 and leetcode.base.Node 3 contain 'a', so the number of nodes within the subtree of leetcode.base.Node 1 containing 'a' is 2.
 */
public class NodesInASubtree {

    // Tree leetcode.base.Node
    class Node {
        public int val;

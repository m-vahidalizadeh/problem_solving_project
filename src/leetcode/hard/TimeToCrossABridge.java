...
public class TimeToCrossABridge {
    ...
    public int findCrossingTime(int n, int k, int[][] time) {
        int ans = 0, free = 0;
        PriorityQueue<int[]> l = new PriorityQueue<>((a, b) -> a[0] - b[0]), r = new PriorityQueue<>((a, b) -> a[0] - b[0]), ll = new PriorityQueue<>((a, b) -> a[0] != b[0] ? b[0] - a[0] : b[1] - a[1]), rr = new PriorityQueue<>((a, b) -> a[0] != b[0] ? b[0] - a[0] : b[1] - a[1]);
        for (int i = 0; i < time.length; i++) ll.add(new int[]{time[i][0] + time[i][2], i});
